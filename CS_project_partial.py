...
def main():
    ...
    try:
        ...
        print(f"[INFO] Biometric key (encrypted): {biometric_key_encrypted}")
        ...
        # You can now potentially use biometric_key_encrypted here if needed for a more complex reverse scrambling
